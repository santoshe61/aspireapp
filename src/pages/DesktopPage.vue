  ...
  <q-page>
    ...
    <div class="q-mt-lg">
      ...
      <div class="row items-center">
        ...
        <div class="col-auto">
          <q-btn no-caps color="primary" @click="newCardDialog = true">
            <img src="/icons/box-white.svg" />
            <span class="q-ml-sm">New card</span>
          </q-btn>
          <q-dialog
    ...
    <q-card>
      <q-carousel
        ...
        padding
        height="328px"
        class="text-white rounded-borders q-mt-xl"
      ...
      <div v-else class="q-my-xl text-white rounded-borders my-card disabled">
